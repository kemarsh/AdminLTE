...
<?php if (isset($debug)) { ?>
    <div id="alDebug" class="alert alert-warning alert-dismissible fade show" role="alert">
...
<?php if (strlen($success) > 0) { ?>
    <div id="alInfo" class="alert alert-info alert-dismissible fade show" role="alert">
...
<?php if (strlen($error) > 0) { ?>
    <div id="alError" class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs">
            <li class="nav-item" role="presentation">
                <a class="nav-link<?php echo $tab === "sysadmin" ? " active" : "" ?>" href="#sysadmin" aria-controls="sysadmin" aria-expanded="<?php echo $tab === "sysadmin" ? "true" : "false"; ?>" role="tab" data-toggle="tab">System</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link<?php echo $tab === "adlists" ? " active" : "" ?>" href="#adlists" aria-controls="adlists" aria-expanded="<?php echo $tab === "adlists" ? "true" : "false"; ?>" role="tab" data-toggle="tab">Adlists</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link<?php echo $tab === "dns" ? " active" : "" ?>" href="#dns" aria-controls="dns" aria-expanded="<?php echo $tab === "dns" ? "true" : "false"; ?>" role="tab" data-toggle="tab">DNS</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link<?php echo $tab === "piholedhcp" ? " active" : "" ?>" href="#piholedhcp" aria-controls="piholedhcp" aria-expanded="<?php echo $tab === "piholedhcp" ? "true" : "false"; ?>" role="tab" data-toggle="tab">DHCP</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link<?php echo $tab === "api" ? " active" : "" ?>" href="#api" aria-controls="api" aria-expanded="<?php echo $tab === "api" ? "true" : "false"; ?>" role="tab" data-toggle="tab">API / Web interface</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link<?php echo $tab === "privacy" ? " active" : "" ?>" href="#privacy" aria-controls="privacy" aria-expanded="<?php echo $tab === "privacy" ? "true" : "false"; ?>" role="tab" data-toggle="tab">Privacy</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link<?php echo $tab === "teleporter" ? " active" : "" ?>" href="#teleporter" aria-controls="teleporter" aria-expanded="<?php echo $tab === "teleporter" ? "true" : "false"; ?>" role="tab" data-toggle="tab">Teleporter</a>
            </li>
        </ul>
        <div class="tab-content">
            <!-- ######################################################### System admin ######################################################### -->
            <div id="sysadmin" class="tab-pane fade<?php echo $tab === "sysadmin" ? " active show" : "" ?>">
                <div class="row mt-3">
                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered dt-responsive nowrap">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-break"><?php echo htmlentities($piHoleIPv6); ?></td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="col-md-6">
                        <div class="card card-outline card-secondary">
                            <div class="card-header">
                                <h3 class="card-title">FTL Information</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
            ...
            <!-- ######################################################### Adlists ######################################################### -->
            <div id="adlists" class="tab-pane fade<?php echo $tab === "adlists" ? " active show" : "" ?>">
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="card card-outline card-secondary">
                            <div class="card-header">
                                <h3 class="card-title">Adlists used to generate Pi-hole's Gravity</h3>
                            </div>
                            <div class="card-body">
            ...
            <!-- ######################################################### DHCP ######################################################### -->
            <div id="piholedhcp" class="tab-pane fade<?php echo $tab === "piholedhcp" ? " active show" : "" ?>">
                <?php
                // Pi-hole DHCP server
                ...
                <form role="form" method="post">
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            <div class="card card-outline card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">DHCP Settings</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="card card-outline card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">Advanced DHCP settings</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <table id="DHCPLeasesTable" class="table table-striped table-bordered dt-responsive nowrap w-100" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th>MAC address</th>
                                                        <th>IP address</th>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table id="DHCPStaticLeasesTable" class="table table-striped table-bordered dt-responsive nowrap w-100"  cellspacing="0">
                                                <thead>
                                                <tr>
                                                    <th>MAC address</th>
                                                    <th>IP address</th>
            ...
            <!-- ######################################################### DNS ######################################################### -->
            <div id="dns" class="tab-pane fade<?php echo $tab === "dns" ? " active show" : "" ?>">
                <form role="form" method="post">
                    <div class="row mt-3">
                        <div class="col-lg-6">
                            <div class="card card-outline card-warning">
                                <div class="card-header">
                                    <h1 class="card-title">Upstream DNS Servers</h1>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                        ...
                        <div class="col-lg-6">
                            <div class="card card-outline card-warning">
                                <div class="card-header">
                                    <h1 class="card-title">Interface listening behavior</h1>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card card-outline card-warning">
                                <div class="card-header">
                                    <h3 class="card-title">Advanced DNS settings</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
            ...
            ?>
            <div id="api" class="tab-pane fade<?php echo $tab === "api" ? " active show" : "" ?>">
                <div class="row mt-3">
                    <div class="col-md-6">
                        <form role="form" method="post">
                            <div class="card card-outline card-warning">
            ...
            ?>
            <div id="privacy" class="tab-pane fade<?php echo $tab === "privacy" ? " active show" : "" ?>">
                <div class="row mt-3">
                    <div class="col-md-12">
                        <form role="form" method="post">
                            <div class="card card-outline card-warning">
            ...
            <!-- ######################################################### Teleporter ######################################################### -->
            <div id="teleporter" class="tab-pane fade<?php echo $tab === "teleporter" ? " active show" : "" ?>">
                <div class="row mt-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <button type="submit" class="btn btn-light">Backup</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <button type="submit" class="btn btn-light" name="action" value="in">Restore</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card card-outline card-warning">
                            <div class="card-header">
                                <h3 class="card-title">Teleporter</h3>
                            </div>
                            <div class="card-body">
