    ...
    <div class="col-md-6 col-sm-8">
        <div class="card card-outline card-info">
            <div class="card-header text-center">
                ...
                <h2 id="cookieInfo" class="card-title text-danger my-2" hidden>Verify that cookies are allowed for <code><?php echo $_SERVER['HTTP_HOST']; ?></code></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group pull-left">
                                ...
                                <label>
                                <input type="checkbox" id="logincookie" name="persistentlogin">Remember me for 7 days</label></div>
                            </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-tools pull-right">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                            <i class="fa <?php echo $wrongpassword ? "fa-minus" : "fa-plus" ?>"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="card-body">
