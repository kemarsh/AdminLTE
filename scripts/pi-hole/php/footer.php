...
*  Please see LICENSE file for your rights under this license. */ ?>
    ...
    <div class="modal fade" id="customDisableModal" tabindex="-1" role="dialog" aria-labelledby="customDisableModalTitle">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="customDisableModalTitle">Custom disable timeout</h4>
                ...
                <div class="modal-body">
                    <div class="input-group">
                        ...
                        <div class="input-group-btn" data-toggle="buttons">
                            ...
                            <label id="btnMins" class="btn btn-light active">
...
?>
    ...
    <footer class="main-footer">
        ...
        <div style="display: inline-block">
            <strong><a href="https://pi-hole.net/donate/" rel="noopener" target="_blank"><i class="fa fa-heart"></i> Donate</a></strong> if you found this useful.
        </div>
    </footer>
</div> <!-- ./wrapper -->
