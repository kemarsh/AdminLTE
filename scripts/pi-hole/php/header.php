...
<body class="sidebar-mini accent-lightblue text-sm<?php echo $boxedlayout ? " layout-boxed" : "" ?>">
<noscript>
    <!-- JS Warning -->
    <div>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-lightblue elevation-2">
        <a class="brand-link navbar-lightblue text-lg" href="index.php">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel my-2 pb-2 d-flex text-xs">
                <div class="image align-self-center">
                    <img src="img/logo.svg" alt="Pi-hole logo" width="45" height="67" style="width: 45px; height: 67px;">
                </div>
                <div class="info">
                    <p class="mb-1 font-weight-bolder">Status</p>
                    ...
                    <?php
                        ...
                        echo '<li id="status">';
                        if ($pistatus === "1") {
                            echo '<i class="fa fa-circle text-green-light mr-1"></i> Active';
                        } elseif ($pistatus === "0") {
                            echo '<i class="fa fa-circle text-red mr-1"></i> Offline';
                        } elseif ($pistatus === "-1") {
                            echo '<i class="fa fa-circle text-red mr-1"></i> DNS service not running';
                        } else {
                            echo '<i class="fa fa-circle text-orange mr-1"></i> Unknown';
                        }

                        // CPU Temp
                        if ($FTL) {
                            if ($celsius >= -273.15) {
                                echo '<span id="temperature" class="ml-2"><i class="fa fa-fire mr-1 ';
                            ...
                            echo '<span id="temperature" class="ml-2"><i class="fa fa-circle text-red mr-1"></i> FTL offline</span>';
                        }
                        echo '</li>';

                        echo '<li><span title="Detected ' . $nproc . ' cores"><i class="fa fa-circle mr-1 ';
                        if ($loaddata[0] > $nproc) {
                            echo "text-red";
                        } else {
                        ...
                        echo '<li><i class="fa fa-circle mr-1 ';
