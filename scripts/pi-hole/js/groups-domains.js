...
function addDomain() {
  ...
  $.ajax({
    ...
    success: function (response) {
      utils.enableAll();
      if (response.success) {
        utils.showAlert("success", "fa fa-plus", "Successfully added " + domain_regex, domain);
        domainEl.val("");
        commentEl.val("");
...
function deleteDomain() {
  ...
  $.ajax({
    ...
    success: function (response) {
      utils.enableAll();
      if (response.success) {
        utils.showAlert("success", "fa fa-trash-o", "Successfully deleted " + domain_regex, domain);
