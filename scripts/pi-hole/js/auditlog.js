      ...
      if (Object.prototype.hasOwnProperty.call(data.top_queries, domain)) {
        ...
        domaintable.append(
          "<tr><td>" +
            ...
            "</td> <td>" +
            '<button type="button" class="btn btn-light btn-sm text-red"><i class="fa fa-ban"></i> Blacklist</button>' +
            '<button type="button" class="btn btn-light btn-sm text-orange"><i class="fa fa-balance-scale"></i> Audit</button>' +
            "</td> </tr> "
        );
      }
    }
