...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-secondary" id="adlists-list">
            ...
            <div class="card-body">
                <table id="adlistsTable" class="display table table-striped table-bordered w-100" cellspacing="0">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Address</th>
                ...
                <button type="button" id="resetButton" hidden="true" class="btn btn-light btn-sm text-red">Reset sorting</button>
            </div>
        </div>
    </div>
</div>
